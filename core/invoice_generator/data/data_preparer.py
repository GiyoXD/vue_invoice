...
def prepare_data_rows(
    ...
    if isinstance(data_source, dict):
        ...
        if raw_pallet_counts and isinstance(raw_pallet_counts, list):
            pallet_counts_for_rows = [p if p is not None else 0 for p in raw_pallet_counts]
        else:
            pallet_counts_for_rows = [0] * num_data_rows_from_source
        ...
        for row_data in data_source:
            ...
            pallet_counts_for_rows.append(p_count if p_count is not None else 0)
